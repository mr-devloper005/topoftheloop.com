...
const quickLinks = [
  { label: 'Go to PDF library', href: '/pdf', icon: FileText },
  { label: 'Go to Help', href: '/help', icon: Search },
  { label: 'Go to Settings', href: '/settings', icon: Settings },
]

const createActions = [{ label: 'Create PDF profile', href: '/create/pdf', icon: Plus }]
